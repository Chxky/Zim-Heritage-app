...
final List<VisualAid> ecdVisualAids = [
  // ECD A - Language
  VisualAid(id: 'va_ecda_greeting', category: 'Language', title: 'Greetings Chart',
    description: 'Children learning to greet with a smile and wave',
    labels: ['Hello', 'Good morning', 'Wave', 'Smile'], gradeLevel: 'ECD A'),
  VisualAid(id: 'va_ecda_body', category: 'Language', title: 'My Body Parts',
  ...
  VisualAid(id: 'va_ecdb_seasons', category: 'Environmental Science', title: 'Seasons of the Year',
  ...
  // Grade 1
  VisualAid(id: 'va_g1_phonics', category: 'English', title: 'Phonics Sound Chart',
    description: 'Letter sounds with example words and pictures',
    labels: ['b - ball', 'c - cat', 'd - dog', 'f - fish', 'g - goat'], gradeLevel: 'Grade 1'),
  VisualAid(id: 'va_g1_numbers', category: 'Mathematics', title: 'Numbers 1-100 Chart',
  ...
  VisualAid(id: 'va_g1_shapes', category: 'Mathematics', title: '2D Shapes',
  ...
  VisualAid(id: 'va_g1_flag', category: 'Heritage', title: 'Zimbabwe National Flag',
  ...
  // Grade 2
  VisualAid(id: 'va_g2_multiplication', category: 'Mathematics', title: 'Multiplication Table 1-5',
    description: 'Multiplication tables with arrays showing groups of objects',
    labels: ['1x', '2x', '3x', '4x', '5x', 'Arrays'], gradeLevel: 'Grade 2'),
  VisualAid(id: 'va_g2_community', category: 'Heritage', title: 'Community Helpers',
  ...
  VisualAid(id: 'va_g2_plants', category: 'Science', title: 'Parts of a Plant',
  ...
  VisualAid(id: 'va_g2_time', category: 'Mathematics', title: 'Telling the Time',
