...
final Map<String, List<Subject>> curriculumByGrade = {
  ...
  'Form 1': [
    ...
    Subject(id: 'o1_frs', name: 'Family and Religious Studies', description: 'Foundations of ATR, Christianity, Islam, Judaism, and Unhu/Ubuntu Ethics', gradeLevel: 'Form 1', color: '0xFF795548', icon: 'church'),
  ...
  'Form 2': [
    ...
    Subject(id: 'o2_frs', name: 'Family and Religious Studies', description: 'Comparative religion, rites of passage, family values, and social ethics', gradeLevel: 'Form 2', color: '0xFF795548', icon: 'church'),
...
List<Topic> _allTopics = [
  ...
  Topic(id: 'o1_frs_1', subjectId: 'o1_frs', name: 'Foundations of Family & Religion', description: 'Concepts of family, religion, and African Indigenous Religion (AIR)', subtopics: ['Family structures in Zimbabwe', 'Role of religion in society', 'Supreme Being (Mwari/Nyadzi)', 'Ancestral veneration (Vadzimu/Amakhosi)'], gradeLevel: 'Form 1', term: 'Term 1'),
  Topic(id: 'o1_frs_2', subjectId: 'o1_frs', name: 'Judaism and Christianity Foundations', description: 'Origins and sacred literature', subtopics: ['Abrahamic covenant', 'Moses and the Ten Commandments', 'Life and teachings of Jesus Christ', 'Parables and moral lessons'], gradeLevel: 'Form 1', term: 'Term 2'),
  Topic(id: 'o1_frs_3', subjectId: 'o1_frs', name: 'Unhu/Ubuntu and Social Ethics', description: 'Moral values and community solidarity', subtopics: ['Principles of Unhu/Ubuntu', 'Respect for elders', 'Taboos and totems (Mitupo/Izibongo)', 'Conflict resolution in AIR'], gradeLevel: 'Form 1', term: 'Term 3'),
  Topic(id: 'o2_frs_1', subjectId: 'o2_frs', name: 'African Traditional Religion (AIR) & Rites of Passage', description: 'Sacred ceremonies and rituals', subtopics: ['Birth and naming rituals', 'Initiation rites', 'Marriage customs (Kuroora/Ukulobola)', 'Death and Kurova Guva/Umbuyiso ceremonies'], gradeLevel: 'Form 2', term: 'Term 1'),
  Topic(id: 'o2_frs_2', subjectId: 'o2_frs', name: 'Islam & Comparative Religious Practices', description: 'Islamic beliefs and world religions', subtopics: ['Prophet Muhammad (PBUH)', 'The Five Pillars of Islam', 'The Holy Qur\'an', 'Comparative worship and sacred sites'], gradeLevel: 'Form 2', term: 'Term 2'),
  Topic(id: 'o2_frs_3', subjectId: 'o2_frs', name: 'Family Dynamics & Contemporary Moral Issues', description: 'Family preservation and ethics', subtopics: ['Parental responsibility', 'Substance abuse prevention', 'Gender roles and equity', 'Environmental stewardship in religion'], gradeLevel: 'Form 2', term: 'Term 3'),
  ...
  Topic(id: 'o3_frs_3', subjectId: 'o3_frs', name: 'Biblical Studies & Prophecy', description: 'Old and New Testament prophets', subtopics: ['Old Testament Prophets (Amos, Hosea)', 'Social justice in prophecy', 'Sermon on the Mount', 'Early Christian community'], gradeLevel: 'Form 3', term: 'Term 3'),
  ...
  Topic(id: 'o4_frs_3', subjectId: 'o4_frs', name: 'Religion, Peace & National Reconciliation', description: 'Peacebuilding and harmony', subtopics: ['Religion and peacebuilding', 'National unity and healing', 'Religious tolerance', 'Ubuntu in governance'], gradeLevel: 'Form 4', term: 'Term 3'),
  ...
  Topic(id: 'a5_frs_3', subjectId: 'a5_frs', name: 'Old & New Testament Hermeneutics', description: 'Exegesis and theological analysis', subtopics: ['Form criticism', 'Redaction criticism', 'The Pauline epistles', 'Synoptic problem'], gradeLevel: 'Form 5', term: 'Term 3'),
  ...
  Topic(id: 'a6_frs_3', subjectId: 'a6_frs', name: 'A-Level FRS & Divinity Exam Mastery', description: 'Complete paper 1 & paper 2 revision', subtopics: ['Essay structuring & thesis design', 'Textual exegesis practice', 'Historiography of religion', 'Mock exam paper walkthroughs'], gradeLevel: 'Form 6', term: 'Term 3'),
];
