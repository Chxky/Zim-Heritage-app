...
List<Province> getProvinces() => [
  const Province(id: 'prov_bul', name: 'Bulawayo', population: 1651000, districts: [
  ...
  const Province(id: 'prov_har', name: 'Harare', population: 3150000, districts: [
  ...
  const Province(id: 'prov_mas', name: 'Masvingo', population: 1585000, districts: [
  ...
  const Province(id: 'prov_mid', name: 'Midlands', population: 1815000, districts: [
  ...
  const Province(id: 'prov_man', name: 'Manicaland', population: 1950000, districts: [
  ...
  const Province(id: 'prov_mat_n', name: 'Matabeleland North', population: 750000, districts: [
  ...
  const Province(id: 'prov_mat_s', name: 'Matabeleland South', population: 710000, districts: [
...
List<NdsGoal> getNdsGoals() => [
  const NdsGoal(id: 'goal1', title: 'Universal Primary Completion', description: 'Every child completes primary education by 2030, aligned with SDG 4 and Vision 2030.', progress: 0.82, target: '100% by 2030', milestones: ['85% by 2025 (current: 82%)', '92% by 2027', '100% by 2030'], color: '0xFF2E7D32'),
  const NdsGoal(id: 'goal2', title: 'Secondary Education Transformation', description: 'Increase secondary enrolment from 52% to 85% through infrastructure, scholarships, and flexible learning pathways.', progress: 0.58, target: '85% by 2030', milestones: ['65% by 2025 (current: 58%)', '75% by 2027', '85% by 2030'], color: '0xFF1565C0'),
  const NdsGoal(id: 'goal3', title: 'Digital Learning For All', description: 'Every school connected with ICT infrastructure, solar power, and digital learning platforms.', progress: 0.32, target: '100% by 2030', milestones: ['50% by 2025 (current: 32%)', '75% by 2027', '100% by 2030'], color: '0xFF7B1FA2'),
  const NdsGoal(id: 'goal4', title: 'Teacher Excellence', description: 'All teachers trained, equipped with digital tools, and supported through continuous professional development.', progress: 0.72, target: '90% trained by 2025', milestones: ['81% trained (current)', '85% by 2026', '90% by 2025'], color: '0xFFE65100'),
  const NdsGoal(id: 'goal5', title: 'Heritage-Based Curriculum Implementation', description: 'Full rollout of Heritage-Based Curriculum across all 15 grade levels with quality learning materials.', progress: 0.65, target: '100% by 2026', milestones: ['ECD-Grade 4 complete', 'Grade 5-7 by 2024', 'Form 1-6 by 2026'], color: '0xFFAD1457'),
];
