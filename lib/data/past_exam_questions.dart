...
final Map<String, List<PastExamQuestion>> pastExamQuestions = {
  ...
  'g7_sho': [
    PastExamQuestion(id: 'pe_g7_sho_1', subjectId: 'g7_sho', gradeLevel: 'Grade 7', year: '2023', term: 'Term 1', paper: '1',
      question: 'Tsangudza zvirevo zviviri (Explain two proverbs). (5 marks)', marks: 5,
      answer: 'Students must provide two standard indigenous proverbs and their literal and figurative meanings.',
      explanation: 'Proverbs carry the wisdom of the ancestors.', topic: 'Shona/Ndebele Concepts'),
  ],
  'g7_sci': [
    PastExamQuestion(id: 'pe_g7_sci_1', subjectId: 'g7_sci', gradeLevel: 'Grade 7', year: '2023', term: 'Term 1', paper: '1',
      question: 'What is the process of photosynthesis? (5 marks)', marks: 5,
      ...
      explanation: 'It occurs in the chloroplasts using the green pigment chlorophyll.', topic: 'General Science Concepts'),
  ],
  'g7_agr': [
    PastExamQuestion(id: 'pe_g7_agr_1', subjectId: 'g7_agr', gradeLevel: 'Grade 7', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe two methods of soil conservation. (5 marks)', marks: 5,
      answer: '1. Crop rotation: growing different crops in succession to preserve nutrients. 2. Terracing: creating flat steps on slopes to reduce water runoff.',
      explanation: 'Soil conservation prevents erosion and maintains fertility.', topic: 'Agriculture Concepts'),
  ],
  'g7_vpa': [
    PastExamQuestion(id: 'pe_g7_vpa_1', subjectId: 'g7_vpa', gradeLevel: 'Grade 7', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Visual and Performing Arts. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Visual and Performing Arts involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Visual and Performing Arts requires both theoretical knowledge and practical application.', topic: 'Visual and Performing Arts Concepts'),
  ],
  'g7_frm': [
    PastExamQuestion(id: 'pe_g7_frm_1', subjectId: 'g7_frm', gradeLevel: 'Grade 7', year: '2023', term: 'Term 1', paper: '1',
      question: 'Discuss the importance of rites of passage in traditional African communities. (5 marks)', marks: 5,
      answer: 'Rites of passage (like birth, initiation, marriage, and death ceremonies) transition individuals from one social status to another, fostering community cohesion and spiritual continuity.',
      explanation: 'They are essential for maintaining social order and connection to ancestors.', topic: 'Family, Religion and Moral Education Concepts'),
  ],
  'g7_pe': [
    PastExamQuestion(id: 'pe_g7_pe_1', subjectId: 'g7_pe', gradeLevel: 'Grade 7', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Physical Education, Sport and Mass Displays. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Physical Education, Sport and Mass Displays involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Physical Education, Sport and Mass Displays requires both theoretical knowledge and practical application.', topic: 'Physical Education, Sport and Mass Displays Concepts'),
  ],
  'g7_ict': [
    PastExamQuestion(id: 'pe_g7_ict_1', subjectId: 'g7_ict', gradeLevel: 'Grade 7', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Information and Communication Technology. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Information and Communication Technology involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Information and Communication Technology requires both theoretical knowledge and practical application.', topic: 'Information and Communication Technology Concepts'),
  ],
  'o1_sho': [
    PastExamQuestion(id: 'pe_o1_sho_1', subjectId: 'o1_sho', gradeLevel: 'Form 1', year: '2023', term: 'Term 1', paper: '1',
      question: 'Tsangudza zvirevo zviviri (Explain two proverbs). (5 marks)', marks: 5,
      answer: 'Students must provide two standard indigenous proverbs and their literal and figurative meanings.',
      explanation: 'Proverbs carry the wisdom of the ancestors.', topic: 'Shona/Ndebele Concepts'),
  ],
  'o1_agr': [
    PastExamQuestion(id: 'pe_o1_agr_1', subjectId: 'o1_agr', gradeLevel: 'Form 1', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe two methods of soil conservation. (5 marks)', marks: 5,
      answer: '1. Crop rotation: growing different crops in succession to preserve nutrients. 2. Terracing: creating flat steps on slopes to reduce water runoff.',
      explanation: 'Soil conservation prevents erosion and maintains fertility.', topic: 'Agriculture Concepts'),
  ],
  'o1_frm': [
    PastExamQuestion(id: 'pe_o1_frm_1', subjectId: 'o1_frm', gradeLevel: 'Form 1', year: '2023', term: 'Term 1', paper: '1',
      question: 'Discuss the importance of rites of passage in traditional African communities. (5 marks)', marks: 5,
      answer: 'Rites of passage (like birth, initiation, marriage, and death ceremonies) transition individuals from one social status to another, fostering community cohesion and spiritual continuity.',
      explanation: 'They are essential for maintaining social order and connection to ancestors.', topic: 'Family, Religion and Moral Education Concepts'),
  ],
  'o1_pe': [
    PastExamQuestion(id: 'pe_o1_pe_1', subjectId: 'o1_pe', gradeLevel: 'Form 1', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Physical Education, Sport and Mass Displays. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Physical Education, Sport and Mass Displays involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Physical Education, Sport and Mass Displays requires both theoretical knowledge and practical application.', topic: 'Physical Education, Sport and Mass Displays Concepts'),
  ],
  'o1_ict': [
    PastExamQuestion(id: 'pe_o1_ict_1', subjectId: 'o1_ict', gradeLevel: 'Form 1', year: '2023', term: 'Term 1', paper: '1',
      question: 'Explain the difference between hardware and software. (5 marks)', marks: 5,
      answer: 'Hardware refers to the physical components of a computer, while software refers to the programs and instructions that tell the hardware what to do.',
      explanation: 'Hardware is tangible, software is intangible.', topic: 'Computer Science Concepts'),
  ],
  'o2_eng': [
    PastExamQuestion(id: 'pe_o2_eng_1', subjectId: 'o2_eng', gradeLevel: 'Form 2', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of English Language. (5 marks)', marks: 5,
      answer: 'The fundamental principles of English Language involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of English Language requires both theoretical knowledge and practical application.', topic: 'English Language Concepts'),
  ],
  'o2_sho': [
    PastExamQuestion(id: 'pe_o2_sho_1', subjectId: 'o2_sho', gradeLevel: 'Form 2', year: '2023', term: 'Term 1', paper: '1',
      question: 'Tsangudza zvirevo zviviri (Explain two proverbs). (5 marks)', marks: 5,
      answer: 'Students must provide two standard indigenous proverbs and their literal and figurative meanings.',
      explanation: 'Proverbs carry the wisdom of the ancestors.', topic: 'Shona/Ndebele Concepts'),
  ],
  'o2_geo': [
    PastExamQuestion(id: 'pe_o2_geo_1', subjectId: 'o2_geo', gradeLevel: 'Form 2', year: '2023', term: 'Term 1', paper: '1',
      question: 'Explain the causes of global warming. (5 marks)', marks: 5,
      answer: 'Global warming is primarily caused by the greenhouse effect, driven by human activities like burning fossil fuels and deforestation, which increase carbon dioxide levels in the atmosphere.',
      explanation: 'Greenhouse gases trap heat in the Earth\'s atmosphere.', topic: 'Geography Concepts'),
  ],
  'o2_agr': [
    PastExamQuestion(id: 'pe_o2_agr_1', subjectId: 'o2_agr', gradeLevel: 'Form 2', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe two methods of soil conservation. (5 marks)', marks: 5,
      answer: '1. Crop rotation: growing different crops in succession to preserve nutrients. 2. Terracing: creating flat steps on slopes to reduce water runoff.',
      explanation: 'Soil conservation prevents erosion and maintains fertility.', topic: 'Agriculture Concepts'),
  ],
  'o2_bus': [
    PastExamQuestion(id: 'pe_o2_bus_1', subjectId: 'o2_bus', gradeLevel: 'Form 2', year: '2023', term: 'Term 1', paper: '1',
      question: 'Define a balance sheet and its purpose. (5 marks)', marks: 5,
      answer: 'A balance sheet is a financial statement that shows a company\'s assets, liabilities, and equity at a specific point in time. It provides a snapshot of the company\'s financial health.',
      explanation: 'Assets = Liabilities + Equity is the fundamental accounting equation.', topic: 'Commerce Concepts'),
  ],
  'o2_frm': [
    PastExamQuestion(id: 'pe_o2_frm_1', subjectId: 'o2_frm', gradeLevel: 'Form 2', year: '2023', term: 'Term 1', paper: '1',
      question: 'Discuss the importance of rites of passage in traditional African communities. (5 marks)', marks: 5,
      answer: 'Rites of passage (like birth, initiation, marriage, and death ceremonies) transition individuals from one social status to another, fostering community cohesion and spiritual continuity.',
      explanation: 'They are essential for maintaining social order and connection to ancestors.', topic: 'Family, Religion and Moral Education Concepts'),
  ],
  'o2_pe': [
    PastExamQuestion(id: 'pe_o2_pe_1', subjectId: 'o2_pe', gradeLevel: 'Form 2', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Physical Education. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Physical Education involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Physical Education requires both theoretical knowledge and practical application.', topic: 'Physical Education Concepts'),
  ],
  'o3_eng': [
    PastExamQuestion(id: 'pe_o3_eng_1', subjectId: 'o3_eng', gradeLevel: 'Form 3', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of English Language. (5 marks)', marks: 5,
      answer: 'The fundamental principles of English Language involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of English Language requires both theoretical knowledge and practical application.', topic: 'English Language Concepts'),
  ],
  'o3_mat': [
    PastExamQuestion(id: 'pe_o3_mat_1', subjectId: 'o3_mat', gradeLevel: 'Form 3', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Mathematics. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Mathematics involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Mathematics requires both theoretical knowledge and practical application.', topic: 'Mathematics Concepts'),
  ],
  'o3_sho': [
    PastExamQuestion(id: 'pe_o3_sho_1', subjectId: 'o3_sho', gradeLevel: 'Form 3', year: '2023', term: 'Term 1', paper: '1',
      question: 'Tsangudza zvirevo zviviri (Explain two proverbs). (5 marks)', marks: 5,
      answer: 'Students must provide two standard indigenous proverbs and their literal and figurative meanings.',
      explanation: 'Proverbs carry the wisdom of the ancestors.', topic: 'Shona/Ndebele Concepts'),
  ],
  'o3_his': [
    PastExamQuestion(id: 'pe_o3_his_1', subjectId: 'o3_his', gradeLevel: 'Form 3', year: '2023', term: 'Term 1', paper: '1',
      question: 'Outline the main causes of the First World War. (5 marks)', marks: 5,
      answer: 'Militarism, Alliances, Imperialism, and Nationalism (MAIN), triggered by the assassination of Archduke Franz Ferdinand in 1914.',
      explanation: 'The MAIN acronym is a useful way to remember the long-term causes.', topic: 'History Concepts'),
  ],
  'o3_geo': [
    PastExamQuestion(id: 'pe_o3_geo_1', subjectId: 'o3_geo', gradeLevel: 'Form 3', year: '2023', term: 'Term 1', paper: '1',
      question: 'Explain the causes of global warming. (5 marks)', marks: 5,
      answer: 'Global warming is primarily caused by the greenhouse effect, driven by human activities like burning fossil fuels and deforestation, which increase carbon dioxide levels in the atmosphere.',
      explanation: 'Greenhouse gases trap heat in the Earth\'s atmosphere.', topic: 'Geography Concepts'),
  ],
  'o3_acc': [
    PastExamQuestion(id: 'pe_o3_acc_1', subjectId: 'o3_acc', gradeLevel: 'Form 3', year: '2023', term: 'Term 1', paper: '1',
      question: 'Define a balance sheet and its purpose. (5 marks)', marks: 5,
      answer: 'A balance sheet is a financial statement that shows a company\'s assets, liabilities, and equity at a specific point in time. It provides a snapshot of the company\'s financial health.',
      explanation: 'Assets = Liabilities + Equity is the fundamental accounting equation.', topic: 'Accounting Concepts'),
  ],
  'o3_eco': [
    PastExamQuestion(id: 'pe_o3_eco_1', subjectId: 'o3_eco', gradeLevel: 'Form 3', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Economics. (5 marks)', marks: 5,
  ...
  'o3_frs': [
    PastExamQuestion(id: 'pe_o3_frs_1', subjectId: 'o3_frs', gradeLevel: 'Form 3', year: '2023', term: 'Term 1', paper: '1',
      question: 'Discuss the importance of rites of passage in traditional African communities. (5 marks)', marks: 5,
      answer: 'Rites of passage (like birth, initiation, marriage, and death ceremonies) transition individuals from one social status to another, fostering community cohesion and spiritual continuity.',
      explanation: 'They are essential for maintaining social order and connection to ancestors.', topic: 'Family and Religious Studies Concepts'),
  ],
  'o4_sho': [
    PastExamQuestion(id: 'pe_o4_sho_1', subjectId: 'o4_sho', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'Tsangudza zvirevo zviviri (Explain two proverbs). (5 marks)', marks: 5,
      answer: 'Students must provide two standard indigenous proverbs and their literal and figurative meanings.',
      explanation: 'Proverbs carry the wisdom of the ancestors.', topic: 'Shona/Ndebele Concepts'),
  ],
  'o4_bio': [
    PastExamQuestion(id: 'pe_o4_bio_1', subjectId: 'o4_bio', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'What is the process of photosynthesis? (5 marks)', marks: 5,
      answer: 'Photosynthesis is the process by which green plants use sunlight to synthesize nutrients from carbon dioxide and water, releasing oxygen as a byproduct.',
      explanation: 'It occurs in the chloroplasts using the green pigment chlorophyll.', topic: 'Biology Concepts'),
  ],
  'o4_che': [
    PastExamQuestion(id: 'pe_o4_che_1', subjectId: 'o4_che', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'What is the process of photosynthesis? (5 marks)', marks: 5,
      answer: 'Photosynthesis is the process by which green plants use sunlight to synthesize nutrients from carbon dioxide and water, releasing oxygen as a byproduct.',
      explanation: 'It occurs in the chloroplasts using the green pigment chlorophyll.', topic: 'Chemistry Concepts'),
  ],
  'o4_phy': [
    PastExamQuestion(id: 'pe_o4_phy_1', subjectId: 'o4_phy', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'What is the process of photosynthesis? (5 marks)', marks: 5,
      answer: 'Photosynthesis is the process by which green plants use sunlight to synthesize nutrients from carbon dioxide and water, releasing oxygen as a byproduct.',
      explanation: 'It occurs in the chloroplasts using the green pigment chlorophyll.', topic: 'Physics Concepts'),
  ],
  'o4_his': [
    PastExamQuestion(id: 'pe_o4_his_1', subjectId: 'o4_his', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'Outline the main causes of the First World War. (5 marks)', marks: 5,
      answer: 'Militarism, Alliances, Imperialism, and Nationalism (MAIN), triggered by the assassination of Archduke Franz Ferdinand in 1914.',
      explanation: 'The MAIN acronym is a useful way to remember the long-term causes.', topic: 'History Concepts'),
  ],
  'o4_geo': [
    PastExamQuestion(id: 'pe_o4_geo_1', subjectId: 'o4_geo', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'Explain the causes of global warming. (5 marks)', marks: 5,
      answer: 'Global warming is primarily caused by the greenhouse effect, driven by human activities like burning fossil fuels and deforestation, which increase carbon dioxide levels in the atmosphere.',
      explanation: 'Greenhouse gases trap heat in the Earth\'s atmosphere.', topic: 'Geography Concepts'),
  ],
  'o4_acc': [
    PastExamQuestion(id: 'pe_o4_acc_1', subjectId: 'o4_acc', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'Define a balance sheet and its purpose. (5 marks)', marks: 5,
      answer: 'A balance sheet is a financial statement that shows a company\'s assets, liabilities, and equity at a specific point in time. It provides a snapshot of the company\'s financial health.',
      explanation: 'Assets = Liabilities + Equity is the fundamental accounting equation.', topic: 'Accounting Concepts'),
  ],
  'o4_eco': [
    PastExamQuestion(id: 'pe_o4_eco_1', subjectId: 'o4_eco', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Economics. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Economics involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Economics requires both theoretical knowledge and practical application.', topic: 'Economics Concepts'),
  ],
  'o4_com': [
    PastExamQuestion(id: 'pe_o4_com_1', subjectId: 'o4_com', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'Explain the difference between hardware and software. (5 marks)', marks: 5,
      answer: 'Hardware refers to the physical components of a computer, while software refers to the programs and instructions that tell the hardware what to do.',
      explanation: 'Hardware is tangible, software is intangible.', topic: 'Computer Science Concepts'),
  ],
  'o4_ftd': [
    PastExamQuestion(id: 'pe_o4_ftd_1', subjectId: 'o4_ftd', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Food Technology and Design. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Food Technology and Design involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Food Technology and Design requires both theoretical knowledge and practical application.', topic: 'Food Technology and Design Concepts'),
  ],
  'o4_frs': [
    PastExamQuestion(id: 'pe_o4_frs_1', subjectId: 'o4_frs', gradeLevel: 'Form 4', year: '2023', term: 'Term 1', paper: '1',
      question: 'Discuss the importance of rites of passage in traditional African communities. (5 marks)', marks: 5,
      answer: 'Rites of passage (like birth, initiation, marriage, and death ceremonies) transition individuals from one social status to another, fostering community cohesion and spiritual continuity.',
      explanation: 'They are essential for maintaining social order and connection to ancestors.', topic: 'Family and Religious Studies Concepts'),
  ],
  'a5_che': [
    PastExamQuestion(id: 'pe_a5_che_1', subjectId: 'a5_che', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'What is the process of photosynthesis? (5 marks)', marks: 5,
      answer: 'Photosynthesis is the process by which green plants use sunlight to synthesize nutrients from carbon dioxide and water, releasing oxygen as a byproduct.',
      explanation: 'It occurs in the chloroplasts using the green pigment chlorophyll.', topic: 'Chemistry Concepts'),
  ],
  'a5_phy': [
    PastExamQuestion(id: 'pe_a5_phy_1', subjectId: 'a5_phy', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'What is the process of photosynthesis? (5 marks)', marks: 5,
      answer: 'Photosynthesis is the process by which green plants use sunlight to synthesize nutrients from carbon dioxide and water, releasing oxygen as a byproduct.',
      explanation: 'It occurs in the chloroplasts using the green pigment chlorophyll.', topic: 'Physics Concepts'),
  ],
  'a5_his': [
    PastExamQuestion(id: 'pe_a5_his_1', subjectId: 'a5_his', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'Outline the main causes of the First World War. (5 marks)', marks: 5,
      answer: 'Militarism, Alliances, Imperialism, and Nationalism (MAIN), triggered by the assassination of Archduke Franz Ferdinand in 1914.',
      explanation: 'The MAIN acronym is a useful way to remember the long-term causes.', topic: 'History Concepts'),
  ],
  'a5_geo': [
    PastExamQuestion(id: 'pe_a5_geo_1', subjectId: 'a5_geo', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'Explain the causes of global warming. (5 marks)', marks: 5,
      answer: 'Global warming is primarily caused by the greenhouse effect, driven by human activities like burning fossil fuels and deforestation, which increase carbon dioxide levels in the atmosphere.',
      explanation: 'Greenhouse gases trap heat in the Earth\'s atmosphere.', topic: 'Geography Concepts'),
  ],
  'a5_bus': [
    PastExamQuestion(id: 'pe_a5_bus_1', subjectId: 'a5_bus', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'Define a balance sheet and its purpose. (5 marks)', marks: 5,
      answer: 'A balance sheet is a financial statement that shows a company\'s assets, liabilities, and equity at a specific point in time. It provides a snapshot of the company\'s financial health.',
      explanation: 'Assets = Liabilities + Equity is the fundamental accounting equation.', topic: 'Business Studies Concepts'),
  ],
  'a5_lit': [
    PastExamQuestion(id: 'pe_a5_lit_1', subjectId: 'a5_lit', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Literature in English. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Literature in English involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Literature in English requires both theoretical knowledge and practical application.', topic: 'Literature in English Concepts'),
  ],
  'a5_div': [
    PastExamQuestion(id: 'pe_a5_div_1', subjectId: 'a5_div', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'Discuss the importance of rites of passage in traditional African communities. (5 marks)', marks: 5,
      answer: 'Rites of passage (like birth, initiation, marriage, and death ceremonies) transition individuals from one social status to another, fostering community cohesion and spiritual continuity.',
      explanation: 'They are essential for maintaining social order and connection to ancestors.', topic: 'Divinity Concepts'),
  ],
  'a5_acc': [
    PastExamQuestion(id: 'pe_a5_acc_1', subjectId: 'a5_acc', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'Define a balance sheet and its purpose. (5 marks)', marks: 5,
      answer: 'A balance sheet is a financial statement that shows a company\'s assets, liabilities, and equity at a specific point in time. It provides a snapshot of the company\'s financial health.',
      explanation: 'Assets = Liabilities + Equity is the fundamental accounting equation.', topic: 'Accounting Concepts'),
  ],
  'a5_csc': [
    PastExamQuestion(id: 'pe_a5_csc_1', subjectId: 'a5_csc', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'Explain the difference between hardware and software. (5 marks)', marks: 5,
      answer: 'Hardware refers to the physical components of a computer, while software refers to the programs and instructions that tell the hardware what to do.',
      explanation: 'Hardware is tangible, software is intangible.', topic: 'Computer Science Concepts'),
  ],
  'a5_frs': [
    PastExamQuestion(id: 'pe_a5_frs_1', subjectId: 'a5_frs', gradeLevel: 'Form 5', year: '2023', term: 'Term 1', paper: '1',
      question: 'Discuss the importance of rites of passage in traditional African communities. (5 marks)', marks: 5,
      answer: 'Rites of passage (like birth, initiation, marriage, and death ceremonies) transition individuals from one social status to another, fostering community cohesion and spiritual continuity.',
      explanation: 'They are essential for maintaining social order and connection to ancestors.', topic: 'Family and Religious Studies Concepts'),
  ],
  'a6_phy': [
    PastExamQuestion(id: 'pe_a6_phy_1', subjectId: 'a6_phy', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'What is the process of photosynthesis? (5 marks)', marks: 5,
      answer: 'Photosynthesis is the process by which green plants use sunlight to synthesize nutrients from carbon dioxide and water, releasing oxygen as a byproduct.',
      explanation: 'It occurs in the chloroplasts using the green pigment chlorophyll.', topic: 'Physics Concepts'),
  ],
  'a6_his': [
    PastExamQuestion(id: 'pe_a6_his_1', subjectId: 'a6_his', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'Outline the main causes of the First World War. (5 marks)', marks: 5,
      answer: 'Militarism, Alliances, Imperialism, and Nationalism (MAIN), triggered by the assassination of Archduke Franz Ferdinand in 1914.',
      explanation: 'The MAIN acronym is a useful way to remember the long-term causes.', topic: 'History Concepts'),
  ],
  'a6_geo': [
    PastExamQuestion(id: 'pe_a6_geo_1', subjectId: 'a6_geo', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'Explain the causes of global warming. (5 marks)', marks: 5,
      answer: 'Global warming is primarily caused by the greenhouse effect, driven by human activities like burning fossil fuels and deforestation, which increase carbon dioxide levels in the atmosphere.',
      explanation: 'Greenhouse gases trap heat in the Earth\'s atmosphere.', topic: 'Geography Concepts'),
  ],
  'a6_eco': [
    PastExamQuestion(id: 'pe_a6_eco_1', subjectId: 'a6_eco', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Economics. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Economics involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Economics requires both theoretical knowledge and practical application.', topic: 'Economics Concepts'),
  ],
  'a6_bus': [
    PastExamQuestion(id: 'pe_a6_bus_1', subjectId: 'a6_bus', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'Define a balance sheet and its purpose. (5 marks)', marks: 5,
      answer: 'A balance sheet is a financial statement that shows a company\'s assets, liabilities, and equity at a specific point in time. It provides a snapshot of the company\'s financial health.',
      explanation: 'Assets = Liabilities + Equity is the fundamental accounting equation.', topic: 'Business Studies Concepts'),
  ],
  'a6_lit': [
    PastExamQuestion(id: 'pe_a6_lit_1', subjectId: 'a6_lit', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'Describe the fundamental principles of Literature in English. (5 marks)', marks: 5,
      answer: 'The fundamental principles of Literature in English involve understanding its core methodologies and applying them to solve practical problems in the field.',
      explanation: 'Mastery of Literature in English requires both theoretical knowledge and practical application.', topic: 'Literature in English Concepts'),
  ],
  'a6_div': [
    PastExamQuestion(id: 'pe_a6_div_1', subjectId: 'a6_div', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'Discuss the importance of rites of passage in traditional African communities. (5 marks)', marks: 5,
      answer: 'Rites of passage (like birth, initiation, marriage, and death ceremonies) transition individuals from one social status to another, fostering community cohesion and spiritual continuity.',
      explanation: 'They are essential for maintaining social order and connection to ancestors.', topic: 'Divinity Concepts'),
  ],
  'a6_acc': [
    PastExamQuestion(id: 'pe_a6_acc_1', subjectId: 'a6_acc', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'Define a balance sheet and its purpose. (5 marks)', marks: 5,
      answer: 'A balance sheet is a financial statement that shows a company\'s assets, liabilities, and equity at a specific point in time. It provides a snapshot of the company\'s financial health.',
      explanation: 'Assets = Liabilities + Equity is the fundamental accounting equation.', topic: 'Accounting Concepts'),
  ],
  'a6_csc': [
    PastExamQuestion(id: 'pe_a6_csc_1', subjectId: 'a6_csc', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'Explain the difference between hardware and software. (5 marks)', marks: 5,
      answer: 'Hardware refers to the physical components of a computer, while software refers to the programs and instructions that tell the hardware what to do.',
      explanation: 'Hardware is tangible, software is intangible.', topic: 'Computer Science Concepts'),
  ],
  'a6_frs': [
    PastExamQuestion(id: 'pe_a6_frs_1', subjectId: 'a6_frs', gradeLevel: 'Form 6', year: '2023', term: 'Term 1', paper: '1',
      question: 'Discuss the importance of rites of passage in traditional African communities. (5 marks)', marks: 5,
      answer: 'Rites of passage (like birth, initiation, marriage, and death ceremonies) transition individuals from one social status to another, fostering community cohesion and spiritual continuity.',
      explanation: 'They are essential for maintaining social order and connection to ancestors.', topic: 'Family and Religious Studies Concepts'),
  ],
